...
import { commonAbi } from "./commonAbi";

export const abi = {
  MONDrop: {
    address: "0xc63AC713090af6d8A59aF189cc7d6953BF72d8dE",
    abi: [
      {
        inputs: [
          {
  ...
  TOSHIDrop: {
    address: "0x57b83f0EBB782Fe92B734261B072FA3d08EC65F9",
    abi: commonAbi,
    chain: base,
  },
  CELODrop: {
    address: "0x9234972b2C42041dcB6500a5CFA19455c3f67cD1",
    abi: [
      {
        inputs: [
          {
  ...
  DONUTDrop: {
    address: "0x2380347Fc0ba8C9972CDff4da3762e1838558A26",
    abi: commonAbi,
    chain: base,
  },
  BRACkYDrop: {
  ...
  AiSubscription: {
    address: "0xCF791F5973D9536000E8b8dc7532e6D2A1Efc7fb",
    abi: [
      {
        inputs: [
          {
            internalType: "uint256",
            name: "_pricePerMonthUSD",
            type: "uint256",
          },
          {
            internalType: "address",
  ...
  sukantoDrop: {
    address: "0xd1664A9053A0FABa6f9e798F4f368BD938a1d756",
    abi: commonAbi,
    chain: base,
  },
} as const;
